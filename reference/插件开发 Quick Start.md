...
2. 本文也并非插件开发的说明文档
   ...
   3. 思源的插件开发的文档并不充分（人手不足），如果你想要自行研究，请参考
      ...
      4. 或者加入思源爱好者 QQ 群进行技术咨询
         ...
         ![image](https://b3logfile.com/file/2025/05/siyuan/1646569891270/assets/image-20240731195519-xgw9ya7.png)
...
解决这个问题的最简单的办法是：<u>插入的 style 标签的 id 要以 snippetCSS 为开头，来模拟一个代码片段样式</u>。
