...
describe("plugin actions", () => {
  ...
  test("recognizes valid action keys", () => {
    ...
    expect(isActionKey("create-top100-large-documents-report")).toBe(true);
    expect(isActionKey("create-doc-concept-map")).toBe(true);
    ...
    expect(isActionKey("recognize-doc-images")).toBe(true);
    expect(isActionKey("translate-doc-paragraphs")).toBe(true);
