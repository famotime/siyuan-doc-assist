...
A SiYuan Notes plugin (v1.3.0, minAppVersion 3.5.7) that adds document extraction, organization, and editing tools. Built with TypeScript + Vite 6, compiled to CommonJS format as required by SiYuan's plugin system.
